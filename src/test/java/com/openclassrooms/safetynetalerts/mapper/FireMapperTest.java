...
public class FireMapperTest {
    ...
    private final FireMapper fireMapper = new FireMapperImpl();

    @Test
    @DisplayName("Should map person and medical record to FirePersonDTO")
    void shouldMapPersonAndMedicalRecordToFirePersonDTO() {
        ...
        FirePersonDTO dto = fireMapper.toFirePersonDTO(person, record, 45);

...
public interface IPersonCrudService {
     ...
     *
     * <p>Rejet si une personne existe déjà avec le même prénom et nom (comparaison insensible à la casse).</p>
     *
     ...
     *
     * <p>La personne à mettre à jour est identifiée par prénom + nom (insensible à la casse).</p>
     *
